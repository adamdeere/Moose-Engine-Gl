...
int main(void)
{
    ...
    ShaderClass lightingShader; // you can name your shader files however you like
    lightingShader.InitShader("Shaders/shader-vertex.glsl", "Shaders/shader-fragment.glsl");
